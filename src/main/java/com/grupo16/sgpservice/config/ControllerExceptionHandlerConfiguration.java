package com.grupo16.sgpservice.config;
...
import com.grupo16.sgpservice.exception.ExceptionJson;
...
//	private static final String AUTH_CONSTRAINT_VIOLATION = "constraintViolation";
	...
	@ResponseBody
	public ResponseEntity<String> hacleOptimisticLockingFailureException(OptimisticLockingFailureException ex){
		return ResponseEntity.status(HttpStatus.CONFLICT)
				.body("Erro de concorrência: O recurso foi atualizado por outro usuário."
